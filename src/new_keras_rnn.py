...
from data_process.text_preprocess import generate_vector_of_word, generate_vectors_of_text, lineToTensor, text_preprocessing
...
layer = keras.layers.SimpleRNN(128)(layer)
